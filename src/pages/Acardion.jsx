          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center">
              {articles.slice(1).map((article) => (
                <article
                  key={article.id}
                  className="bg-white rounded-lg shadow-md hover:shadow-lg transition flex flex-col mx-auto w-full sm:w-[90%]"
                >
                  <img
                    src={article.image}
                    alt={article.title}
      ...
      <section className="w-full max-w-4xl   px-4 sm:px-6 lg:px-8 py-16 bg-rgb(247, 249, 250)">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center">
          {faqs.map((faq) => (
            <div
              key={faq.id}
              className="border border-slate-200 rounded-lg bg-white mx-auto w-full lg:w-[90%]"
            >
              <button
